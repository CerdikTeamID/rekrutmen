        ...
        <div class="card">
            <div class="header">
                ...
                <div class="pull-right">
                    <a href="<?= base_url() ?>Kaur/laporan" title="Cetak" class="btn btn-secondary">
                            ...
                            foreach ($apply as $row) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?= base_url() ?>Kaur/Detail_Calon_Pelamar/<?= $row->id_apply_job ?>"> <button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
