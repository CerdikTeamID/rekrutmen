...
<div class="block-header">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h2>Detail Pelamar Diterima</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Kaur"><i class="fa fa-dashboard"></i></a></li>
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Kaur/Pelamar_Diterima">Data Lowongan</a></li>
                <li class="breadcrumb-item active">Detail Pelamar Diterima</li>
            </ul>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
...
<div id="doc_print">
    <div class="row clearfix">
                    ...
                    <div class="body table-responsive">
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" style="background-color: aqua; font-weight:bold;">Total Pelamar Yang Diterima : <?= $total['Total'] ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="col-lg-12 col-md-12" id="no_print">
            <div class="card">
                <div class="body">
                    <h4 style="text-align: center;">Data Pelamar Yang Diterima</h4>
                    <div class="body table-responsive">
                                ...
                                foreach ($pelamar as $row) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?= base_url() ?>Kaur/Detail_Pelamar/<?= $row->id_apply_job ?>"> <button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
