...
<div class="block-header">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h2>Laporan Pelamar Tidak Diterima</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>KepalaHRD"><i class="fa fa-dashboard"></i></a></li>
                <li class="breadcrumb-item active">Laporan Pelamar Tidak Diterima</li>
            </ul>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
...
<script>
    $(function() {
        ...
        $('#search').click(function() {
            ...
            $.ajax({
                url: "../KepalaHRD/get_laporan_tidak_diterima",
                type: "GET",
                dataType: "JSON",
                data: {
