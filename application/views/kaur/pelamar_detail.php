...
<div class="block-header">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>KepalaHRD"><i class="fa fa-dashboard"></i></a></li>
                <li class="breadcrumb-item"><a href="<?= base_url() ?>KepalaHRD/Pelamar_Diterima"> Data Lowongan</a></li>
                <li class="breadcrumb-item"><a href="<?= base_url() ?>KepalaHRD/Detail_Pelamar_Diterima/<?= $apply['id_lowongan'] ?>"> Detail Pelamar Diterima</a></li>
...
<div class="row clearfix">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card">
            <div class="body">
                <h2 style="text-align: center;">Hasil Test</h2>
                <h2 style="text-align: center; background-color:aqua"><?= $apply['hasil_test'] ?></h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card">
            <div class="body">
                <h2 style="text-align: center;">Hasil Psikotes</h2>
                <h2 style="text-align: center; background-color:aqua"><?= $apply['hasil_psikotes'] ?></h2>
            </div>
        </div>
    </div>

    <div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
        <?php if ($apply['status_hasil'] == 'Sedang Di Proses') { ?>
            <a href="<?= base_url() ?>KepalaHRD/ApproveApply/<?= $apply['id_apply_job'] ?>"><button class="btn btn-success"><i class="fa fa-check"></i> Approve</button></a>
            <a href="<?= base_url() ?>KepalaHRD/CancelApply/<?= $apply['id_apply_job'] ?>"><button class="btn btn-danger"><i class="fa fa-close"></i> Reject</button></a>
        <?php } ?>
