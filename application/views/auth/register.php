...
<head>
    <title>Halaman Daftar Akun | Rekrutmen Karyawan</title>
    <meta charset="utf-8">
...
<body data-theme="light" class="font-nunito">
    ...
    <div id="wrapper" class="theme-cyan">
        <div class="vertical-align-wrap">
            <div class="row justify-content-center auth-main">
                <div class="auth-box">
                    <!-- <div class="top">
                        <img src="<?= base_url(); ?>assets/logo-anna.jpg" alt="">
                        <h3 class="text-light" style="font-weight:bold;">Rumah Sakit Anna Pekayon</h3>
                    </div> -->
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <p class="lead">Silakan Buat Akun Anda</p>
                        </div>
                        <div class="body">
                            <form class="form-auth-small" action="<?= base_url() ?>Auth/daftar" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="signup-password" class="control-label sr-only">Kata Sandi</label>
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Your Password" required>
                                </div>
                                <div class="form-group">
                                    <label for="signup-password" class="control-label sr-only">Konfirm Sandi</label>
                                    <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Your Password" required>
                                    <span id='message'></span>
                                </div>
                                <button type="submit" class="btn btn-primary btn-lg btn-block">Daftar Akun</button>
                                <div class="bottom">
                                    <span class="helper-text">Sudah Punya Akun? <a href="<?php echo site_url('auth');?>">Masuk Akun</a></span>
                                </div>
                            </form>
    ...
    <!-- END WRAPPER -->
        ...
        <!-- FOOTER -->
        <footer class="footer" style="padding: 0 0 0 0;">
