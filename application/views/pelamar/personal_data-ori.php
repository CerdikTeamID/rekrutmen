...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <form action="<?= base_url() ?>User/updateDataPelamar" method="POST" enctype="multipart/form-data" id="form-data-diri">
                <div class="body">
                    <h6>Fota Profil</h6>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p>Unggah foto.
                                <br> <em>Gambar tidak boleh lebih dari 500kb</em>
                            </p>
                ...
                <div class="body">
                    <h6 style="font-weight: bold;">Informasi Pelamar</h6>
                    <hr>
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="">No KTP</label>
                                <input type="hidden" name="id" id="ktp" value="<?= $personal_data['id_pelamar'] ?>">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="No Hp *" name="hp" id="no_hp" required value="<?= $personal_data['hp'] ?>">
                            </div>
                            <div class="form-group">
