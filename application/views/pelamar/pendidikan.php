        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    <a href="<?= base_url() ?>Pelamar/Tambah_Pendidikan"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pendidikan</button></a>
                </div>
...
<div class="row clearfix">
    ...
    <?php foreach ($pendidikan as $row) { ?>
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <a href="<?= base_url() ?>Pelamar/Edit_Pendidikan/<?= $row->id_pendidikan ?>">
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-2">
                ...
                <!-- <a href="<?= base_url() ?>Pelamar/deletePendidikan/<?= $row->id_pendidikan ?>" class="delete-btn"> 
