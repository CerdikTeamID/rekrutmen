...
<div class="block-header">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Pelamar/Cari_Lowongan_Kerja"><i class="fa fa-dashboard"></i></a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="details col-lg-9 col-md-12">
                                    ...
                                    <div class="action" style="float: right;">
                                        <a href="<?= base_url() ?>Pelamar/Apply/<?= $row->id_lowongan ?>"><button class="btn btn-primary" type="button">Kirim Lamaran</button></a>
                                        <!-- <a href="<?= base_url() ?>Pelamar/Detail_Lowongan/<?= $row->id_lowongan ?>"><button class="btn btn-default" type="button">Detail Lamaran</button></a> -->
                                    </div>
                                </div>
                            </div>
                        </td>
