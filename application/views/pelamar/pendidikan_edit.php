    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Pelamar/Pendidikan">Data Pendidikan</a></li>
...
<div class="row clearfix">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card planned_task">
            ...
            <div class="body">
                <form action="<?= base_url() ?>Pelamar/editDataPendidikan" method="POST">
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="row" style="margin-left: 3px;">
                                        ...
                                        <select name="pendidikan_terakhir" id="pendidikan_terakhir" style="width: 98%;" class="form-control">
                                            <option value=""></option>
                                            <option value="SMA" <?= $pendidikan['pendidikan_terakhir'] == 'SMA' ? 'selected' : '' ?>>SMA</option>
                                            <option value="D3" <?= $pendidikan['pendidikan_terakhir'] == 'Diploma Tiga (D3)' ? 'selected' : '' ?>>Diploma Tiga (D3)</option>
