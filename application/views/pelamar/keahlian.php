        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    <a href="<?= base_url() ?>Pelamar/Tambah_Keahlian"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Keahlian</button></a>
                </div>
    ...
    foreach ($keahlian as $row) { ?>
        <div class="col-lg-12">
            <div class="card planned_task">
                <a href="<?= base_url() ?>Pelamar/Edit_Keahlian/<?= $row->id_keahlian ?>">
                    <div class="body">
                        <div class="row">
                            <div class="col-lg-1">
