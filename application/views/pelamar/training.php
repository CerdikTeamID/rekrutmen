        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    <a href="<?= base_url() ?>Pelamar/Tambah_Training"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Training</button></a>
                </div>
    ...
    foreach ($training as $row) { ?>
        <div class="col-lg-12">
            <div class="card planned_task">
                <a href="<?= base_url() ?>Pelamar/Edit_Training/<?= $row->id_training ?>">
                    <div class="body">
                        <div class="row">
                            <div class="col-lg-1">
