    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb"> 
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Pelamar/Cari_Lowongan_Kerja">Lowongan Kerja</a></li>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card planned_task">
            <div class="body">
                ...
                <hr>
                <a href="<?= base_url() ?>Pelamar/Apply/<?= $lowongan['id_lowongan'] ?>"><button class="btn btn-primary"> Apply</button></a>
