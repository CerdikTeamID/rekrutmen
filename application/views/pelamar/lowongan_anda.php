                                    ...
                                    <div class="action" style="float: right;">
                                        <?php if ($row->status_hasil == 'Lolos Seleksi') { ?>
                                            <?php if ($row->hasil_test == NULL) { ?>
                                                <a href="<?= base_url() ?>Pelamar/Test/<?= $row->id_apply_job ?>"><button class="btn btn-primary" type="button">Soal Test</button></a>
                                            <?php } else { ?>
                                                <button class="btn btn-primary"><i class="fa fa-check"></i> Soal Test (Done)</button>
                                            <?php } ?>
                                            <?php if ($row->hasil_psikotes == NULL) { ?>
                                                <a href="<?= base_url() ?>Pelamar/Psikotes/<?= $row->id_apply_job ?>"><button class="btn btn-default" type="button">Soal Psikotes</button></a>
                                            <?php } else { ?>
