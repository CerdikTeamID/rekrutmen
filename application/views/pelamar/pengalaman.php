        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    <a href="<?= base_url() ?>Pelamar/Tambah_Pengalaman"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pengalaman</button></a>
                </div>
...
<div class="row clearfix">
    ...
    <?php foreach ($pengalaman as $row) { ?>
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <a href="<?= base_url() ?>Pelamar/Edit_Pengalaman/<?= $row->id_pengalaman ?>">
                    <div class="body">
                        <div class="row">
                            <div class="col-lg-1">
