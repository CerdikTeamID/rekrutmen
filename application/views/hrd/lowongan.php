        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    ...
                    <a href="<?= base_url() ?>HRD/Tambah_Lowongan"><button type="button" class="btn btn-secondary"><i class="fa fa-plus"></i> Tambah Lowongan</button></a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($row->id_test == NULL) { ?>
                                            <a href="<?= base_url() ?>HRD/Tambah_Soal/<?= $row->id_lowongan ?>"> <button class="btn btn-danger"><i class="fa fa-plus-square-o"></i> Tambah Soal</button></a>
                                        <?php } else { ?>
                                            <a href="<?= base_url() ?>HRD/Soal/<?= $row->id_test ?>"> <button class="btn btn-warning"><i class="fa fa-eye"></i> Lihat Soal</button></a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if ($row->id_psikotes == NULL) { ?>
                                            <a href="<?= base_url() ?>HRD/Tambah_Psikotes/<?= $row->id_lowongan ?>"> <button class="btn btn-danger"><i class="fa fa-plus-square-o"></i> Tambah Psikotes</button></a>
                                        <?php } else { ?>
                                            <a href="<?= base_url() ?>HRD/Psikotes/<?= $row->id_lowongan ?>"> <button class="btn btn-warning"><i class="fa fa-eye"></i> Lihat Psikotes</button></a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <a href="<?= base_url() ?>HRD/Edit_Lowongan/<?= $row->id_lowongan ?>"> <button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a>
