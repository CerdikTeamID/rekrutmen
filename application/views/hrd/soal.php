...
<div class="row clearfix">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form action="<?= base_url() ?>HRD/tambahEditSoal" method="POST">
                    <table class="table">
                        <thead>
                            <tr>
                    ...
                    <div class="row">
                        <div class="col-2">
                            <a href="<?= base_url() ?>HRD/Data_Lowongan"><button type="button" class="btn btn-secondary"><i class="fa fa-arrow-left"> Back</i></button></a>
    ...
    <div class="modal fade" id="edit<?= $row->id_soal ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>HRD/editSoal" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="delete<?= $row->id_soal ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>HRD/deleteSoal" method="POST">
                    <div class="modal-body">
