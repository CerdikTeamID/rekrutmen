    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>HRD/Data_Lowongan">Data Lowongan</a></li>
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form id="basic-form" method="post" action="<?= base_url() ?>HRD/editLowongan" novalidate>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="min_pend" id="min_pend" class="form-control" style="width: 100%;" required>
                                    ...
                                    <option value="Diploma Tiga(D3)" <?= $lowongan['min_pend'] == 'Diploma Tiga(D3)' ? 'selected' : '' ?>>D3</option>
                                    <option value="Strata Satu (S1)" <?= $lowongan['min_pend'] == 'Strata Satu (S1)' ? 'selected' : '' ?>>Strata Satu (S1)</option>
                                    <option value="Strata Dua (S2)" <?= $lowongan['min_pend'] == 'Strata Dua (S2)' ? 'selected' : '' ?>>Strata Dua (S2)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <a href="<?= base_url() ?>HRD/Data_Lowongan"><button type="button" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Kembali</button></a>
                </form>
