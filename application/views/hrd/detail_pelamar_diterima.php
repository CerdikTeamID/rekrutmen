    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>HRD/Pelamar_Diterima">Data Lowongan</a></li>
                                ...
                                foreach ($pelamar as $row) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?= base_url() ?>HRD/Detail_Pelamar/<?= $row->id_apply_job ?>"> <button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
