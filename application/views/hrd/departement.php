...
<div class="block-header">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>HRD"><i class="fa fa-dashboard"></i></a></li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    ...
                    <a data-toggle="modal" data-target="#tambah"><button type="button" class="btn btn-secondary"><i class="fa fa-plus"></i> Tambah Departement</button></a>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($departement as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="modal" data-target="#edit<?= $row->id_departement ?>"> <button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a>
                                        <a data-toggle="modal" data-target="#delete<?= $row->id_departement ?>"> <button class="btn btn-danger"><i class="fa fa-trash-o"></i></button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Departement</h4>
            </div>
            <form action="<?= base_url() ?>Admin/tambahDepartement" method="POST" enctype="multipart/form-data">
...
<?php foreach ($departement as $row) { ?>
    <div class="modal fade" id="edit<?= $row->id_departement ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Edit Departement</h4>
                </div>
                <form action="<?= base_url() ?>Admin/editDepartement" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Departement</label>
                            <input type="hidden" name="id" value="<?= $row->id_departement ?>">
                            <input type="text" name="nama_departement" value="<?= $row->nama_departement ?>" class="form-control" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button>
...
<?php foreach ($departement as $row) { ?>
    <div class="modal fade" id="delete<?= $row->id_departement ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Delete Departement!</h4>
                </div>
