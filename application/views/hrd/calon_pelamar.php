                        ...
                        <tbody>
                            ...
                            foreach ($apply as $row) { ?>
                                <tr>
                                    ...
                                    <td <?= $row->status_hasil == 'Menunggu' ? 'style="background-color:red;" class="text-light"'  : '' ?>><?= $row->status_hasil ?></td>
                                    <td><?= date('d, M Y', strtotime($row->tgl_lamar)) ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?= base_url() ?>HRD/Detail_Calon_Pelamar/<?= $row->id_apply_job ?>"> <button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
