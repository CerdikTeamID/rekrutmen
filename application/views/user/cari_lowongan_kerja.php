                            ...
                            <div class="row">
                                ...
                                <div class="details col-lg-9 col-md-12">
                                    ...
                                    <div class="action" style="float: right;">
                                        <a href="<?= base_url() ?>Pelamar/Apply/<?= $row->id_lowongan ?>"><button class="btn btn-primary" type="button">Apply</button></a>
                                        <a href="<?= base_url() ?>Pelamar/Detail_Lowongan/<?= $row->id_lowongan ?>"><button class="btn btn-default" type="button">Read More..</button></a>
                                    </div>
                                </div>
                            </div>
                        </td>
